      ...
      <div class="container mx-auto px-4 flex items-center justify-between">
        ...
        <div class="hidden lg:flex space-x-8 text-gray-700 items-center">
          ...
          <div class="relative group">
            ...
            <div
              class="hidden group-hover:block absolute top-[calc(100%+2px)] left-0 min-w-[280px] z-50 transform opacity-0 group-hover:opacity-100 transition-all duration-300 shadow-[0_0_20px_rgba(66,226,236,0.15)]"
            >
              <RouterLink
                to="/ponuda-pogrebno"
